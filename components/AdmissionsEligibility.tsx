    ...
    <section className="relative z-20 w-full py-24 md:py-32 bg-transparent overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            Admissions &{" "}
            <span className="font-light" style={{ color: ACCENT }}>Eligibility</span>
          </motion.h2>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{ background: `linear-gradient(to right, transparent, rgba(123,47,255,0.3), transparent)` }}
            />
            ...
            <div>
              ...
              >
                ...
                <span className="text-[10px] sm:text-[11px] font-light tracking-widest uppercase" style={{ color: ACCENT }}>
              ...
              <div className="space-y-4 sm:space-y-5 mb-8 sm:mb-10">
                <div>
                  ...
                  <p className="text-base sm:text-lg font-light flex items-center gap-2" style={{ color: "#1a0050" }}>
                ...
                <div>
                  ...
                  <p className="text-base sm:text-lg font-thin" style={{ color: "#1a0050" }}>15th July 2026</p>
                </div>
              </div>
            </div>

            <a href="https://jainsoft.co.in/application" target="_blank" rel="noopener noreferrer" className="w-full group">
              <motion.button
          ...
          <div className="flex-1 flex flex-col gap-5 sm:gap-6 md:gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 md:gap-8">
              ...
              >
                ...
                <p className="text-[10px] sm:text-[11px] font-light uppercase tracking-[0.2em] mb-2" style={{ color: "rgba(30,0,80,0.35)" }}>
                  Minimum Eligibility
                </p>
                <h4 className="text-2xl sm:text-3xl font-light mb-2" style={{ color: "#1a0050" }}>70-85%</h4>
                <p className="text-[12px] sm:text-[13px] font-thin" style={{ color: "rgba(30,0,80,0.5)" }}>
              ...
              >
                ...
                <h4 className="text-xl sm:text-2xl font-light mb-2" style={{ color: "#1a0050" }}>Hybrid Model</h4>
                <p className="text-[12px] sm:text-[13px] font-thin" style={{ color: "rgba(30,0,80,0.5)" }}>
            ...
            >
              ...
              <div
                className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
                style={{ background: "radial-gradient(ellipse at top left, rgba(123,47,255,0.04), transparent 60%)" }}
              />

              <p className="text-[10px] sm:text-[11px] font-light uppercase tracking-[0.2em] mb-6 sm:mb-8" style={{ color: "rgba(30,0,80,0.35)" }}>
                Admission Process
              </p>
              ...
              <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 sm:gap-0">
                ...
                <motion.div
                  ...
                  style={{ background: ACCENT, boxShadow: "0 0 10px rgba(123,47,255,0.3)" }}
                />
                ...
                <div className="relative z-10 flex flex-row sm:flex-col items-center sm:text-center gap-4 sm:gap-3">
                  ...
                  <div>
                    <h5 className="font-light text-[14px] sm:text-[15px]" style={{ color: "#1a0050" }}>Online Application</h5>
                    <p className="text-[12px] hidden sm:block mt-1 font-thin" style={{ color: "rgba(30,0,80,0.4)" }}>Submit your details</p>
                  </div>
                </div>
                ...
                <div className="relative z-10 flex flex-row sm:flex-col items-center sm:text-center gap-4 sm:gap-3">
                  ...
                  <div>
                    <h5 className="font-light text-[14px] sm:text-[15px]" style={{ color: "#1a0050" }}>Interview Call</h5>
                    <p className="text-[12px] hidden sm:block mt-1 font-thin" style={{ color: "rgba(30,0,80,0.4)" }}>1-on-1 discussion</p>
                  </div>
                </div>
                ...
                <div className="relative z-10 flex flex-row sm:flex-col items-center sm:text-center gap-4 sm:gap-3">
                  ...
                  <div>
                    <h5 className="font-light text-[14px] sm:text-[15px]" style={{ color: "#1a0050" }}>Offer Letter</h5>
                    <p className="text-[12px] hidden sm:block mt-1 font-thin" style={{ color: "rgba(30,0,80,0.4)" }}>Welcome to JAIN</p>
                  </div>
                </div>
