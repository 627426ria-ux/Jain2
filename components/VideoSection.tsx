  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-[#0066ff]/40 to-transparent" />
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#02040a]/60 via-transparent to-transparent pointer-events-none" />
      </motion.div>
    </section>
  );
}